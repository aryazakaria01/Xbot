...
class Config(object):
    ...
    ARQ_API_URL="awoo"
    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = "postgresql://doadmin:AVNS_Ah1gcp8RRgLwZGGH1Z6@db-postgresql-nyc1-65692-do-user-12193171-0.b.db.ondigitalocean.com:25060/defaultdb?sslmode=require
