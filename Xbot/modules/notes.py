...
from Xbot import LOGGER, JOIN_LOGGER, SUPPORT_CHAT, dispatcher, DRAGONS
from Xbot.modules.disable import DisableAbleCommandHandler
from Xbot.modules.helper_funcs.chat_status import user_admin, connection_status
from Xbot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Xbot.modules.helper_funcs.msg_types import get_note_type
        ...
        if note.is_reply:
            ...
            try:
                ...
                if excp.message == "Entity_mention_user_invalid":
                    ...
                    message.reply_text(
                        "This note could not be sent, as it is incorrectly formatted. Ask in @InsaneSupport365 if you can't figure out why!"
                    )
