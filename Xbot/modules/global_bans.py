...
import Xbot.modules.sql.global_bans_sql as sql
from Xbot.modules.sql.users_sql import get_user_com_chats
from Xbot import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from Xbot.modules.helper_funcs.misc import send_to_list
