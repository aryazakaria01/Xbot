...
from Xbot import DRAGONS as SUDO_USERS
from Xbot import pbot
from Xbot.modules.sql import forceSubscribe_sql as sql
...
__help__ = """
  *Force Subscribe:*
  ...
  IronMen Robot can mute members who are not subscribed your channel until they subscribe When enabled I will mute unsubscribed members and show them a unmute button. When they pressed the button I will unmute them
