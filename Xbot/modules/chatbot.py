...
import html
import requests
import Xbot.modules.sql.chatbot_sql as sql
...
from Xbot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Xbot import dispatcher, updater, SUPPORT_CHAT
from Xbot.modules.log_channel import gloggable
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        url = f"https://kukiapi.xyz/api/apikey=1356469075-KUKIkq4WMg5FV4/IronMen/Anonymous/message={anon}"
