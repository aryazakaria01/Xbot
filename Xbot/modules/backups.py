...
import Xbot.modules.sql.notes_sql as sql
from Xbot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Xbot.__main__ import DATA_IMPORT
from Xbot.modules.helper_funcs.chat_status import user_admin
from Xbot.modules.helper_funcs.alternate import typing_action

# from Xbot.modules.rules import get_rules
import Xbot.modules.sql.rules_sql as rulessql

# from Xbot.modules.sql import warns_sql as warnssql
import Xbot.modules.sql.blacklist_sql as blacklistsql
from Xbot.modules.sql import disable_sql as disabledsql

# from Xbot.modules.sql import cust_filters_sql as filtersql
# import Xbot.modules.sql.welcome_sql as welcsql
import Xbot.modules.sql.locks_sql as locksql
from Xbot.modules.connection import connected
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                f"An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @InsaneSupport365"
            )
...
def export_data(update, context):
    ...
    with open("Xbot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Xbot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Xbot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Xbot{}.backup".format(chat_id))  # Cleaning file
