...
from Xbot import OWNER_ID, SUPPORT_CHAT , BOT_USERNAME
from Xbot.events import register
from Xbot import telethn
...
async def lego(event):
    ...
    try:
        ...
        fillcolor = "black"
        shadowcolor = "blue"
        fnt = glob.glob("./Xbot/resources/fonts/*")
        ...
        await event.reply(f"ғʟᴏᴏᴅᴡᴀɪᴛ ᴇʀʀᴏʀ, ʀᴇᴩᴏʀᴛ ᴛʜɪs ᴀᴛ @cl_me_logesh")
