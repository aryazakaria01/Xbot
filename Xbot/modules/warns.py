...
import telegram
from Xbot import TIGERS, WOLVES, dispatcher
from Xbot.modules.disable import DisableAbleCommandHandler
from Xbot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from Xbot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from Xbot.modules.helper_funcs.string_handling import split_quotes
from Xbot.modules.log_channel import loggable
from Xbot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # IronMen's sticker
        keyboard = None
        log_reason = (
