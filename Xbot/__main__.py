...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="✨ sᴜᴩᴩᴏʀᴛ ✨", url=f"https://t.me/gangs_for_udanpirappu"),
    ],
    [
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Xbot.modules." + module_name)
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴩᴩᴏʀᴛ", url=f"https://t.me/gangs_for_udanpirappu"
                        ),
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs", url=f"https://t.me/gangs_for_udanpirappu"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(text="◁", callback_data="IronMen_"),
                    ],
                ]
            ),
        )
...
ᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ [༒MR. ᭄ 𝕋𝕀𝕄𝔼 𝕋ℝ𝔸𝕍𝔼𝕃𝕃𝔼ℝᴮᴬᴰʙᴏʏ](https://t.me/rowdy_of_plus)""",
            ...
            LOGGER.warning(
                f"Bot isn't able to send message to @cl_me_logesh, go and check!"
            )
